...
tfAPIで動画ファイルpredict実行し保存する
"""
#Usage:
# cd C:\Users\shingo\Git\TensorFlow-Object-Detection-API-Tutorial-Train-Multiple-Objects-Windows-10\work_20190402
# python ../../Object_detection_video_edit.py -pb inference_graph\frozen_inference_graph.pb -l ../../label_map.pbtxt -v ../../../test.mov -n 6 -o predict_result/video
# python ../../Object_detection_video_edit.py -pb inference_graph\frozen_inference_graph.pb -l ../../label_map.pbtxt -v ../../IMG_9310.MOV -n 6 -o predict_result/video
...
ap.add_argument("-v", "--PATH_TO_VIDEO", type=str, required=True,
    help="path to video file")
ap.add_argument("-n", "--NUM_CLASSES", type=int, default=6,
...
# 第三引数の画像のサイズは元動画の横縦のサイズに合わせないと保存できない
ret, frame = video.read()
(h, w) = frame.shape[:2]
out = cv2.VideoWriter(os.path.join(output_dir, str(Path(PATH_TO_VIDEO).stem)+'.mp4')
                        , fourcc, fps, (w, h))
